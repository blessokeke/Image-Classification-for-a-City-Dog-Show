...
#       with this function
# Got support from:
#1. calculates_results_stats_hints.py
#2. https://classroom.udacity.com/nanodegrees/nd089/parts/0e93e54e-a93f-4372-8c27-63ae0424cccc/modules/72ab8084-4feb-401a-93c9-65dc0d91f418/lessons/59930ed5-6f24-4cd2-bf0a-c0a0075cd7b4/concepts/75b4ad8e-9d8a-4274-8baf-1aec7fbaaf9a
...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['pct_match'] = (results_stats_dic['n_match']/results_stats_dic['n_images']) * 100 #0.0
    ...
    results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs']/results_stats_dic['n_dogs_img']) * 100 #0.0
    ...
    results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_correct_breed']/results_stats_dic['n_dogs_img']) * 100 #0.0
